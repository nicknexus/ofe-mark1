...
export default function TagDetailPage() {
 ...
 notify.error((e as Error).message || 'Failed to load tag')
 setData(null)
 } finally {
 setLoading(false)
 }
 ...
 <div className="app-icon-tile app-icon-tile-accent w-12 h-12">
 ...
 <h1 className="app-page-title truncate">{data.tag.name}</h1>
 ...
 <h2 className="app-card-title">Metrics using this tag</h2>
 </div>
 {data.kpis.length === 0 ? (
 ...
 <h2 className="app-card-title">Evidence with this tag</h2>
 ...
 className="text-left app-card-interactive p-3 flex gap-3 items-start hover:border-primary-300 hover:bg-primary-50/30"
 >
 ...
 <div className="mt-6 app-card overflow-hidden">
 <div className="px-6 py-4 border-b border-gray-100 bg-gradient-to-b from-gray-50/50 to-transparent flex items-center justify-between">
 <h2 className="app-card-title">Stories with this tag</h2>
 ...
 className="text-left app-card-interactive p-3 flex gap-3 items-start hover:border-primary-300 hover:bg-primary-50/30"
 >
 <div className="app-icon-tile-sm app-icon-tile-accent">

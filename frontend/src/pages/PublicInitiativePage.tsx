                    ...
                    <div className="flex-1 min-w-0 pb-24 lg:pb-0 relative">
                        {switching ? (
                            ...
                            <>
                                ...
                                {activeTab === 'evidence' && <EvidenceTab evidence={filteredEvidence} orgSlug={orgSlug!} initiativeSlug={initiativeSlug!} dateQS={dateQS} tagsById={tagsById} onTagClick={(id) => setSelectedTagIds(prev => prev.includes(id) ? prev.filter(x => x !== id) : [...prev, id])} selectedTagIds={selectedTagIds} brandColor={brandColor} />}

...
function DataPointsList({ updates, kpi, onRefresh }: DataPointsListProps) {
 ...
 return (
 <div key={dataPoint.id} className="app-card">
 {/* Main Data Point Card */}
 <div
 className="p-4 cursor-pointer hover:bg-white/90 transition-all duration-200 rounded-xl"
 ...
 className="text-xs px-2 py-1 bg-evidence-50 text-evidence-600 rounded hover:bg-evidence-100"
 >
 Edit
 </button>
 </div>
 ...
 <div className="w-2 h-2 bg-evidence-500 rounded-full flex-shrink-0"></div>
 <div className="min-w-0 flex-1">
 <span className="text-sm font-medium text-gray-900 block truncate hover:text-primary-700">
 {evidence.title}
 </span>
...
export default function KPIDetailPage() {
 ...
 notify.success('Update added successfully!')
 ...
 className="app-btn app-btn-primary flex items-center justify-center gap-2 px-5 py-2.5 text-sm"
 >
 ...
 className="app-btn app-btn-secondary text-sm disabled:opacity-50"
 ...
 {dateFilter.isActive && (
 <div className="mt-3 p-3 app-card-muted">
 ...
 <div className="xl:col-span-2 app-card p-4 sm:p-5 flex flex-col max-h-[calc(100vh-320px)]">
 ...
 {/* Filtered Total Sum */}
 {dateFilter.isActive && (
 <div className="mb-4 p-3 app-card-muted flex-shrink-0">
 <div className="flex items-center justify-between">
 ...
 <div className="w-14 h-14 rounded-xl bg-gray-100/80 flex items-center justify-center mx-auto mb-4">
 ...
 <button
 onClick={() => setIsUpdateModalOpen(true)}
 className="mt-4 app-btn app-btn-primary px-5 py-2.5 text-sm"
 >

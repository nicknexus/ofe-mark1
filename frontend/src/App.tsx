...
import PublicBeneficiaryGroupPage from './pages/PublicBeneficiaryGroupPage'
...
function App() {
 ...
 <div className="w-16 h-16 mx-auto mb-6 rounded-xl bg-amber-100 flex items-center justify-center">
 ...
 className="px-6 py-3 app-btn app-btn-primary font-semibold transition-colors shadow-lg shadow-primary-500/25"
 >
 Try Again
 </button>
 <button

...
const actions = [
 ...
 icon: Camera,
 gradient: 'from-evidence-500 to-evidence-600',
 lightColor: 'bg-evidence-50',
 ...
 icon: BookOpen,
 gradient: 'from-impact-500 to-impact-600',
 lightColor: 'bg-impact-50',
 textColor: 'text-impact-600',
 },
 {
...
export default function MobileActionsTab({ initiatives, onAction }: MobileActionsTabProps) {
 ...
 className="app-card-interactive w-full flex items-center gap-4 p-4 active:scale-[0.98] text-left"
 >
 ...
 <div
 className="relative app-card rounded-t-3xl w-full max-h-[70vh] flex flex-col animate-in slide-in-from-bottom duration-200"
 ...
 className="app-card-interactive w-full flex items-center gap-3 p-3.5 text-left"
 >

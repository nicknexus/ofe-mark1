        ...
        >
                ...
                <div className="flex items-center justify-between p-4 md:p-6 border-b border-primary-200/40 bg-gradient-to-r from-primary-100/50 to-primary-50/30 backdrop-blur-xl">
                    <div className="flex items-center space-x-3 flex-1 min-w-0">
                        <div className="w-9 h-9 md:w-11 md:h-11 rounded-xl bg-primary-500/15 backdrop-blur-sm flex items-center justify-center border border-primary-300/30 flex-shrink-0">
                ...
                <div className="px-4 md:px-6 py-3 md:py-4 border-b border-primary-100/40 bg-white/30 backdrop-blur-xl">

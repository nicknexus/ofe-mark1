...
export default function KPIFilterBar({
 ...
 {selectedLocations.length > 0 && (
 <span className="ml-1 app-chip app-chip-accent text-xs px-1.5 py-0">{selectedLocations.length}</span>
 )}
 ...
 {selectedLocations.length > 0 && (
 <button onClick={(e) => { e.stopPropagation(); onLocationsChange([]) }} className="text-xs text-primary-700 hover:text-primary-800">Clear</button>
 )}
 </div>
 {locations.map((loc) => (
 ...
 {selectedTags.length > 0 && (
 <span className="ml-1 app-chip app-chip-accent text-xs px-1.5 py-0">{selectedTags.length}</span>
 )}
 ...
 {selectedTags.length > 0 && (
 <button onClick={(e) => { e.stopPropagation(); onTagsChange([]) }} className="text-xs text-primary-700 hover:text-primary-800">Clear</button>
 )}
 </div>
 {tags.map((tag) => (
 ...
 {selectedBeneficiaryGroups.length > 0 && (
 <span className="ml-1 app-chip app-chip-accent text-xs px-1.5 py-0">{selectedBeneficiaryGroups.length}</span>
 )}
 ...
 {selectedBeneficiaryGroups.length > 0 && (
 <button onClick={(e) => { e.stopPropagation(); onBeneficiaryGroupsChange([]) }} className="text-xs text-primary-700 hover:text-primary-800">Clear</button>
 )}
 </div>

    ...
    <section id="why-it-matters" className="py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
            ...
            return (
              <StaggerItem key={stat.headline}>
                <motion.div
                  ...
                  className="h-full bg-white/5 rounded-2xl border border-white/10 p-8"
                >
                  <p className="mb-4">
                    {parsed ? (
                      <AnimatedNumber
        ...
        <div className="group relative overflow-hidden">
          ...
          <div
            className="flex w-max py-2 will-change-transform [animation:why-marquee_36s_linear_infinite] group-hover:[animation-play-state:paused] motion-reduce:[animation:none]"
          >
            {[...supportingStats, ...supportingStats].map((stat, i) => (
              <div
                key={`${stat.description}-${i}`}
                className="w-[300px] shrink-0 mr-4 bg-white/5 rounded-2xl border border-white/10 p-6 shadow-glass"
              >

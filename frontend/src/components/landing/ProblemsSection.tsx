...
function ScrollSwapPanel({ onGetStarted }: { onGetStarted?: () => void }) {
  ...
  return (
    <div ref={containerRef} className="relative h-[155vh]">
      <div className="sticky top-14 z-10 flex h-[calc(100vh-3.5rem)] items-center">
        <div className="w-full max-h-full overflow-hidden rounded-3xl border border-border/50 shadow-glass bg-white">
          <div className="relative bg-ink px-5 sm:px-8 md:px-12 pt-3 sm:pt-4 pb-4">
          ...
          <div className="bg-white px-4 sm:px-6 md:px-8 py-3 sm:py-4 overflow-hidden">
            ...
            <div className="relative mt-3 min-h-[3.75rem] sm:min-h-[3.5rem]">
              <motion.div
                className="absolute inset-0"

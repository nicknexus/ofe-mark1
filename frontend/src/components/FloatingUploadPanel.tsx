...
function UploadRow({ item, onDismiss, onCancel }: { item: UploadItem; onDismiss: () => void; onCancel: () => void }) {
 ...
 {isDone && <CheckCircle2 className="w-5 h-5 text-impact-500" />}
...
export default function FloatingUploadPanel() {
 ...
 return (
 <div className="fixed bottom-4 right-4 z-[100] w-80 app-card-elevated overflow-hidden animate-slide-up-fast">
 {/* Header */}
 <div

            ...
            <div className="bg-white rounded-2xl shadow-bubble border border-gray-100 p-6">
                ...
                {capacity && !capacity.canAdd ? (
                    ...
                    <button
                        ...
                        className="w-full px-4 py-3 text-sm font-medium text-white bg-primary-500 hover:bg-primary-600 rounded-xl transition-colors flex items-center justify-center gap-2"
                    >

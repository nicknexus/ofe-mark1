...
export default function MetricCreditingModal({
 ...
 notify.error('Failed to load credits')
 }
 }
 ...
 notify.error('Failed to delete credit')
 }
 }
 ...
 notify.error('Please fill in all required fields for new credits')
 return
 }
 ...
 notify.error(`Credited value exceeds available amount. Available: ${available}`)
 return
 }
 ...
 notify.success('Credits saved successfully!')
 await onSave()
 onClose()
 } catch (error: any) {
 ...
 return (
 <>
 <ModalFrame panelClassName="bg-white rounded-xl border border-gray-200 max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-app-modal flex flex-col">
 {/* Header */}
 ...
 {selectedClaimId ? (
 <div className="p-4 bg-evidence-50 border border-evidence-200 rounded-lg">
 <div className="flex items-center justify-between">
 <div>
 <div className="text-sm font-medium text-evidence-700">Available to Credit</div>
 <div className="text-2xl font-bold text-primary-700">
 {availableValue.toFixed(2)} {kpi.unit_of_measurement}
 </div>
 </div>
 <div className="text-sm text-evidence-700">
 {selectedClaim && (
 <>
 ...
 <div className="flex items-center justify-between">
 <div>
 <div className="text-sm font-medium text-evidence-700">Available to Credit (Metric Level)</div>
 <div className="text-2xl font-bold text-primary-700">
 {availableValue.toFixed(2)} {kpi.unit_of_measurement}
 </div>
 </div>
 ...
 className="app-input text-sm py-1"
 />
 </div>
 <div>
 <label className="block text-xs font-medium text-gray-600 mb-1">
 ...
 className="app-btn app-btn-primary app-btn-sm flex items-center gap-1"
 >

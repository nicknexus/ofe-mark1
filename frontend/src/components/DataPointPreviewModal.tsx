...
export default function DataPointPreviewModal({
 ...
 <div className="bg-gradient-to-br from-primary-50/80 to-primary-50/40 rounded-xl border border-primary-100/60 overflow-hidden">
 ...
 <div className="w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center border border-primary-200/40">
 ...
 {/* Notes Section */}
 {dataPoint.note && (
 <div className="app-card app-pad">
 ...
 <span className="text-xs text-gray-500 bg-gray-100 px-2 py-0.5 rounded-full">{evidenceList.length}</span>
 </div>
 </div>
 ...
 className={`flex items-center justify-between p-3 rounded-lg transition-all ${onEvidenceClick ? 'hover:bg-gray-50 cursor-pointer hover:shadow-sm' : ''}`}
 >

...
export default function EditDataPointBeneficiariesModal({
 ...
 notify.success('Beneficiary links updated successfully!')
 onRefresh?.()
 onClose()
 } catch (error) {
 ...
 panelClassName="bg-white rounded-xl border border-gray-200 max-w-lg w-full max-h-[80vh] overflow-y-auto shadow-app-modal"
 >

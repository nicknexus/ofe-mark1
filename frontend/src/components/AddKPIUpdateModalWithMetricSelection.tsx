...
export default function AddKPIUpdateModalWithMetricSelection({
 ...
 panelClassName="bg-white w-full h-full md:rounded-xl md:w-full md:max-w-5xl md:max-h-[90vh] md:h-auto overflow-hidden shadow-app-modal md:border md:border-gray-200 transform transition-all duration-200 ease-out flex flex-col"
 >
 {/* Header */}
 <div className="flex items-center justify-between p-4 md:p-6 border-b border-primary-200/40 bg-gradient-to-r from-primary-50 to-primary-50/80">
 <div className="flex items-center space-x-3 flex-1 min-w-0">
 <div className="w-9 h-9 md:w-11 md:h-11 rounded-xl bg-primary-500/15 flex items-center justify-center border border-primary-300/30 flex-shrink-0">
 <svg className="w-5 h-5 md:w-6 md:h-6 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <button
 onClick={onClose}
 className="text-gray-400 hover:text-gray-600 p-2 rounded-xl hover:bg-gray-100 transition-all duration-200 ml-2 md:ml-4 flex-shrink-0"
 >
 <X className="w-5 h-5" />
 </button>
 </div>
 ...
 <div className="px-4 md:px-6 py-3 md:py-4 border-b border-primary-100/40 bg-gray-50">
 {/* Mobile: Simple progress bar */}
 <div className="md:hidden">
 <div className="flex items-center justify-between mb-2">
 <span className="text-xs font-medium text-gray-600">Step {currentStep} of {totalSteps}</span>
 <span className="text-xs font-medium text-primary-600">{steps[currentStep - 1]?.title}</span>
 </div>
 ...
 ? 'bg-primary-500 border-primary-500 text-secondary-900 shadow-lg shadow-primary-500/30'
 : currentStep === step.number
 ? 'bg-primary-500 border-primary-500 text-secondary-900 ring-4 ring-primary-200/50 shadow-lg shadow-primary-500/30'
 ...
 <div className="flex items-center space-x-3 flex-1 min-w-0">
 <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${isSelected ? 'bg-primary-500 text-secondary-900' : 'bg-gray-100'}`}>
 ...
 <Calendar className="w-5 h-5 inline mr-2 text-primary-700" />
 ...
 <div>
 <label className="block text-sm font-semibold text-gray-900 mb-3">
 <MapPin className="w-5 h-5 inline mr-2 text-primary-700" />
 ...
 className="app-btn app-btn-secondary flex items-center gap-2"
 ...
 <div>
 <label className="block text-sm font-semibold text-gray-900 mb-3">
 <Users className="w-5 h-5 inline mr-2 text-primary-700" />
 ...
 className="w-5 h-5 text-primary-700 rounded border-gray-300 focus:ring-primary-500"
 />
 ...
 <div className="bg-evidence-50 border-2 border-evidence-200 rounded-xl p-5 mt-6">
 <p className="text-xs text-evidence-700 leading-relaxed">
 ...
 {/* Navigation Footer */}
 <div className="border-t border-primary-100/40 p-6 bg-gray-50">
 <div className="flex items-center justify-between">
 <button
 type="button"

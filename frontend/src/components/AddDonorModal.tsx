...
export default function AddDonorModal({
 ...
 notify.error('Please enter a donor name')
 return
 }
 ...
 return (
 <ModalFrame panelClassName="bg-white rounded-xl border border-gray-200 max-w-2xl w-full max-h-[90vh] overflow-hidden shadow-app-modal flex flex-col">
 {/* Header */}

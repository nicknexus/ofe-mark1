...
export default function LocationDetailsModal({
 ...
 <ModalFrame
 zIndexClass="z-[70]"
 panelClassName="app-card max-w-7xl w-full h-[90vh] max-h-[90vh] overflow-hidden flex flex-col"
 >
 {/* Header */}
 ...
 className="flex items-center space-x-2 px-3 py-1.5 bg-evidence-50 text-evidence-600 rounded-xl hover:bg-evidence-100 transition-colors text-sm"
 >
 ...
 {/* Left Column - Stories */}
 <div className="app-card overflow-hidden flex flex-col min-h-0 h-full">
 ...
 onStoryClick && story.id
 ? 'hover:shadow-card-hover hover:border-evidence-200 cursor-pointer'
 ...
 className={`app-card transition-all ${
 onMetricClick && group.kpi?.id
 ? 'hover:shadow-card-hover hover:border-evidence-200 cursor-pointer'
 : 'hover:shadow-card-hover'
 }`}
 ...
 <div className="p-2 bg-gradient-to-br from-evidence-500 to-evidence-600 rounded-lg flex-shrink-0 shadow-sm">
 ...
 <span className="text-xl font-bold bg-gradient-to-r from-evidence-600 to-evidence-600 bg-clip-text text-transparent">
 ...
 <div className="w-6 h-6 rounded-full bg-evidence-50 flex items-center justify-center group-hover:bg-evidence-100 transition-colors">
 <BarChart3 className="w-3 h-3 text-primary-700" />
 </div>
 </div>
 )}
 </div>
 ...
 className={`flex items-center justify-between py-1.5 px-2 rounded-md transition-all cursor-pointer hover:bg-gray-50 hover:shadow-card-hover ${idx < evidenceList.length - 1 ? `border-b ${colors.itemBorder}` : ''
 }`}
 >

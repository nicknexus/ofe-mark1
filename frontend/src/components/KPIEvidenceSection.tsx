...
export default function KPIEvidenceSection({ kpi, onRefresh, initiativeId, dateFilter }: KPIEvidenceSectionProps) {
 ...
 return (
 <div className="app-card p-4 sm:p-5 h-full flex flex-col">
 {/* Header */}
 ...
 return (
 <div key={evidenceItem.id} className="p-3 app-card-flat hover:border-evidence-300 hover:shadow-card-hover transition-all duration-200 cursor-pointer" onClick={() => handleEvidenceClick(evidenceItem)}>

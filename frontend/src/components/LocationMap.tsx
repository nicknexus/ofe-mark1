...
interface LocationMapProps {
 ...
 onMetricClick?: (kpiId: string) => void // Callback for metric app-card click
 onStoryClick?: (storyId: string) => void // Callback for story app-card click
...
function CustomMarkerWrapper({
 ...
 isSelected ? 'bg-evidence-500' : 'bg-primary-500'
 }`}
 style={{
...
export default function LocationMap({
 ...
 className="flex-1 px-3 py-2 app-btn app-btn-primary text-xs font-medium transition-colors"
 >
 Apply Filter
 </button>
 </div>
 ...
 <div className="app-card px-3 py-2 shadow-card-lg">
 <div className="flex items-center space-x-2">

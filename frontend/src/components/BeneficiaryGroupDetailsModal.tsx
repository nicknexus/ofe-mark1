...
export default function BeneficiaryGroupDetailsModal({
 ...
 <ModalFrame
 zIndexClass="z-[70]"
 panelClassName="app-card max-w-[95vw] w-full h-[90vh] max-h-[90vh] overflow-hidden flex flex-col"
 >
 {/* Header */}
 ...
 className={`flex items-center justify-between py-1.5 px-2 rounded-md transition-all cursor-pointer hover:bg-gray-50 hover:shadow-card-hover ${

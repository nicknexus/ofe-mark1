...
export default function InteractiveTutorial() {
 ...
 className="app-btn app-btn-ghost app-btn-sm flex items-center gap-1.5"
 >
 ...
 <div key={i} className="flex items-start gap-3 app-card-muted px-4 py-2.5">
 ...
 <div className="mt-5 p-3.5 app-card-muted">
 ...
 <div className="app-card overflow-hidden shadow-card-lg">
 <img
 key={displayedSlide}
 src={slide.image}
 alt={slide.title}

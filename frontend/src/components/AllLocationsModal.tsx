...
export default function AllLocationsModal({ isOpen, onClose }: AllLocationsModalProps) {
 ...
 return (
 <>
 <ModalFrame panelClassName="bg-white rounded-xl w-[95vw] max-w-6xl h-[90vh] flex flex-col overflow-hidden shadow-app-modal border border-gray-200">
 {/* Header */}
 ...
 {/* Map */}
 <div className="lg:col-span-2 app-card p-2 overflow-hidden flex-col min-h-0 hidden lg:flex">
 <LocationMap
 locations={filtered}
 ...
 {/* Sidebar list */}
 <div className="lg:col-span-1 app-card p-3 overflow-hidden flex flex-col min-h-0">

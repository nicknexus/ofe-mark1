...
export default function GroupColumn({
 ...
 <span className={`inline-block w-1.5 h-1.5 rounded-full ${v.ready ? 'bg-impact-500' : 'bg-gray-500'}`} />
 <span className={`text-xs font-medium ${v.ready ? 'text-impact-700' : 'text-gray-700'}`}>

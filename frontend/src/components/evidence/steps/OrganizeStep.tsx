...
export default function OrganizeStep({
 ...
 {selectedCount > 0 && (
 <div className="md:hidden fixed left-3 right-3 bottom-16 z-[80] bg-white border border-gray-200 rounded-xl shadow-2xl p-2.5 flex items-center gap-2 animate-slide-up-fast">
